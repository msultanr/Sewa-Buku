...
public static void main(final String[] args) {
    ...
    int pilih;
    do {
        System.out.println("\t*** Perpustakaan Politeknik Negeri Semarang ***");
...
public static void inputBuku() {
    ...
    int jml, no = 1;
    System.out.print("Banyak buku yang ingin diinputkan : ");
    jml = input.nextInt();
...
public static void pinjamBuku() {
    ...
    System.out.println("4. Akuntansi");
    System.out.println("5. Administrasi Bisni");
        ...
        System.out.println("\tHASIL PENCARIAN\t: ");
            for(int i=0;i<banyak;i++)
            {
                if(buku1[i][0] == kode)
                {
                    ...
                    System.out.println("\tJumlah buku\t : "+banyak);
                    pesan="";
                    break;
                }
                else
